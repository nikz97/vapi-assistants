...
export async function getPatients(): Promise<Patient[]> {
    try{
        const response = await fetch(`http://localhost:3000/api/v1/patient/getAllPatients`, {
            method: "GET",
            headers: {
...
export async function initiateWorkflow(patientId: string) {
    try{
        const response = await fetch(`http://localhost:3000/api/v1/patient/initiateWorkflow`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
